...
class CreatePlantillaItemAppointmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_plantilla_item_appointments', function (Blueprint $table) {
            $table->id('plantilla_item_appointment_id');
        ...
        sqlsrvAddTableColumDescs('dbo', 'tbl_plantilla_item_appointments', [
