...
class CreateServiceRecordAuditsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_service_record_audits', function (Blueprint $table) {
            $table->id('service_records_audit_id');
            ...
            $table->double('salary_per_annum', 14, 2)->default(0);
        ...
        sqlsrvAddTableColumDescs('dbo', 'tbl_service_record_audits', [
    ...
    {
        Schema::dropIfExists('tbl_service_record_audits');
    }
}
