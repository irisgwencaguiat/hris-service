...
class CreatePdsOtherInfoQuestionAuditsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_pds_other_info_question_audits', function (Blueprint $table) {
            $table->id('pds_other_info_question_audit_id');
            ...
            $table->unsignedBigInteger('pds_other_info_question_id');
        ...
        sqlsrvAddTableColumDescs('dbo', 'tbl_pds_other_info_question_audits', [
    ...
    {
        Schema::dropIfExists('tbl_pds_other_info_question_audits');
    }
}
