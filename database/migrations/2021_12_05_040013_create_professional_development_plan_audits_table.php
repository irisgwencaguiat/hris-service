...
class CreateProfessionalDevelopmentPlanAuditsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_professional_development_plan_audits', function (Blueprint $table) {
            $table->id('professional_development_plan_audit_id');
            ...
            $table->unsignedBigInteger('prof_dev_plan_id');
        ...
        sqlsrvAddTableColumDescs('dbo', 'tbl_professional_development_plan_audits', [
    ...
    {
        Schema::dropIfExists('tbl_professional_development_plan_audits');
    }
}
