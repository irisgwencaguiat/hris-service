...
class CreateEvaluationAnswerComponentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_evaluation_answer_components', function (Blueprint $table) {
            $table->id('evaluation_answer_component_id');
        ...
        sqlsrvAddTableColumDescs('dbo', 'tbl_evaluation_answer_components', [
    ...
    {
        Schema::dropIfExists('tbl_evaluation_answer_components');
    }
}
