...
class CreatePdsPersonalInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_pds_personal_infos', function (Blueprint $table) {
            $table->id('pds_personal_info_id');
            ...
            $table->string('gsis_no', 100)->nullable();
            $table->string('pagibig_no', 100)->nullable();
            $table->string('philhealth_no', 100)->nullable();
            $table->string('sss_no', 100)->nullable();
            $table->string('tin_no', 100)->nullable();
            $table->string('agency_employee_no', 100)->nullable()->comment('Agency Employee No.');
        ...
        sqlsrvAddTableColumDescs('dbo', 'tbl_pds_personal_infos', [
    ...
    {
        Schema::dropIfExists('tbl_pds_personal_infos');
    }
}
